...
<form action="preview.php" action="get">
	...
	if ($crostata==1) {
		echo 'Quante crostate <input type="text" name="qcrostata"<br/><br/>';
	}
	else {
		echo '<input type="hidden" name="qcrostata" value="0">';
	}
	...
	if ($cupcake==1) {
		...
		echo '<input type="hidden" name="qcupcake" value="0">';
	}
	...
	if ($freselline==1) {
		...
		echo '<input type="hidden" name="qfreselline" value="0">';
	}
	...
	if ($pagnotta==1) {
		...
		echo '<input type="hidden" name="qpagnotta" value="0">';
	}
	...
	if ($treccia==1) {
		...
		echo '<input type="hidden" name="qtreccia" value="0">';
	}
	...
	if ($baba==1) {
		...
		echo '<input type="hidden" name="qbaba" value="0">';
	}
